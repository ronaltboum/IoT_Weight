...
namespace BarcodeScanner
{
    ...
    public class BarcodeReaderSurfaceView : SurfaceView, ISurfaceHolderCallback, Android.Hardware.Camera.IPreviewCallback, Android.Hardware.Camera.IAutoFocusCallback
    {
        ...
        public BarcodeReaderSurfaceView(Activity activity, MobileBarcodeScanningOptions options, Action<ZXing.Result> callback)
            : base(activity)
        {
            CheckPermissions();
        ...
        protected BarcodeReaderSurfaceView(IntPtr javaReference, JniHandleOwnership transfer)
            ...
            if (points != null && points.Length > 0)
            {
                ...
                if (points.Length == 2)
                {
                    ...
                    drawLine(canvas, paint, points[0], points[1]);
                         ...
                         (rawResult.BarcodeFormat == ZXing.BarcodeFormat.UPC_A ||
                 rawResult.BarcodeFormat == ZXing.BarcodeFormat.EAN_13))
                {
                ...
                else
                {
                    ...
                    foreach (ZXing.ResultPoint point in points)
