...
namespace IoTWeight
{
    ...
    public class WeightHistory : Activity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            FindViewById<ListView>(Resource.Id.listView).ItemClick += WeightHistory_ItemClick;

            //this.ListAdapter = new ArrayAdapter<float>(this, Android.Resource.Layout.SimpleListItem1, lastWeights);
        }

        private void WeightHistory_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            FindViewById<ListView>(Resource.Id.listView).SetSelection(e.Position);
        }
